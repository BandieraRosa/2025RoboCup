...
/* ---------------- 颜色分割阈值 ---------------- */
#define SATURATION_THRESHOLD                                                   \
  50 /**< 最小色彩饱和度阈值，场景变暗/阴影下调，场景变亮/反光上调 */
#define BRIGHTNESS_THRESHOLD                                                   \
  50 /**< 最小亮度阈值，目标颜色变浅下调，背景杂色多上调 */
#define COLOR_DIFF_THRESHOLD                                                   \
  60 /**< 颜色主导阈值，目标颜色变浅下调，背景大块近似红蓝上调*/
...
int find_blobs(const uint8_t *binary_img, int width, int height,
               BlobInfo *blobs, int max_blobs); /**< 返回实际检测到的 blob 数 */
